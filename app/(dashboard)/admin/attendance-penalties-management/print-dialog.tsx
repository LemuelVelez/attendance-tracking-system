...
export const PrintDialog: React.FC<PrintDialogProps> = ({ open, onOpenChange, fines, yearLevels, degreePrograms }) => {
    ...
    return (
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent className="max-w-[90vw] sm:max-w-4xl max-h-[90vh] overflow-y-auto">
                <AlertDialogHeader>
                    <AlertDialogTitle>Print Fines Table</AlertDialogTitle>
                ...
                >
                    <TabsList className="grid w-full grid-cols-2">
                        ...
                        <TabsTrigger value="preview" disabled={!showPrintableTable}>
                            Preview & Download
                        </TabsTrigger>
                    </TabsList>
                        ...
                        {showPrintableTable ? (
                            <div className="border rounded-md p-4">
                                ...
                                <PrintableTable
                                    ...
                                    degreePrograms={selectedDegreePrograms}
                                />
                            </div>
                        ) : (
